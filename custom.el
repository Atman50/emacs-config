...
<p class=\"creator\">%c</p>")))
 ...
 '(plantuml-jar-path "/Users/adamtaylor/bin/plantuml.jar")
...
(custom-set-faces
 ...
 '(ivy-posframe ((t (:inherit default :background "wheat1"))))
 '(which-key-posframe ((t (:inherit default :background "wheat1")))))
