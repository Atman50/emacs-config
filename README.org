...
* python configuration
  ...
  #+END_SRC
    ...
    #+CALL: custom-vars-table(custom-vars='(elpy-modules flycheck-python-pyflakes-executable python-indent-trigger-commands python-shell-completion-setup-code python-shell-completion-string-code python-shell-interpreter python-shell-interpreter-args python-shell-prompt-output-regexp python-shell-prompt-regexp))
