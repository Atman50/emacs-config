...
*** Initialize the package
    This code is meant to insure that both [[https://orgmode.org/][=org-mode=]] (the non-built most recent =org= version available in the org repository) and
...
* [[https://orgmode.org/][=org-mode=]] Configuration
  Org-mode configurations. [[https://github.com/emacsorphanage/org-bullets][=org-bullets=]] used to be part of org but is now outside. Always throw [[https://orgmode.org/][=org-mode=]] buffers into
  [[https://www.emacswiki.org/emacs/FlySpell][=flyspell-mode=]].
